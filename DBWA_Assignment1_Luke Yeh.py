...
def exercise08():
    ...
    quantity = 5
    hello = "hello"
    hello_repeated = len(hello)* hello
    # ------ Place code above here /\ /\ /\ ------
...
def exercise11():
    ...
    # ------ Place code below here \/ \/ \/ ------
    pi = round(math.pi-0.00000000004,10)
    # ------ Place code above here /\ /\ /\ ------
    return pi
...
def exercise16():
    ...
    # ------ Place code below here \/ \/ \/ ------
    a= int(input("type in length of side a"))
    b= int(input("type in length of side b"))
    c= math.sqrt(a**2+b**2)
    # ------ Place code above here /\ /\ /\ ------
    return a, b, c
